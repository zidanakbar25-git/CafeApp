...
<head>
    ...
    <style>
        ...
        .menu-table { border-collapse: separate; border-spacing: 0; width: 100%; }
        .menu-table thead th {
            background: #f9fafb; font-size: 11px; font-weight: 700; letter-spacing: .8px;
            text-transform: uppercase; color: #6b7280; padding: 14px 20px; border-bottom: 1px solid #e5e7eb;
        }
        .menu-table tbody tr { transition: background .15s; }
        .menu-table tbody tr:hover { background: #f9fafb; }
        .menu-table tbody td { padding: 16px 20px; border-bottom: 1px solid #f3f4f6; vertical-align: middle; font-size: 13px; }
        .menu-table tbody tr:last-child td { border-bottom: none; }
        .menu-name { font-weight: 700; color: #0b1533; }
        .badge-type { font-size: 10px; font-weight: 700; padding: 4px 8px; border-radius: 6px; text-transform: uppercase; }
        .bg-food { background-color: #fef3c7; color: #92400e; }
        .bg-drink { background-color: #dbeafe; color: #1e40af; }
        .action-btn {
            width: 36px; height: 36px; border-radius: 10px; border: 1px solid #e5e7eb;
            background: #fff; display: inline-flex; align-items: center; justify-content: center;
            cursor: pointer; transition: background .15s, border-color .15s; text-decoration: none; color: #4b5563;
        }
        .action-btn:hover { background: #f3f4f6; border-color: #d1d5db; color: #111827; }
        .action-btn.danger-btn:hover { background: #fee2e2; border-color: #fca5a5; color: #dc2626; }
        .card-wrap { background: #fff; border-radius: 24px; border: 1px solid #e5e7eb; overflow: hidden; margin: 28px 30px; }
        .card-top { display: flex; justify-content: space-between; align-items: center; padding: 20px 24px; border-bottom: 1px solid #f3f4f6; flex-wrap: wrap; gap: 12px; }
        .card-title { font-size: 20px; font-weight: 700; color: #0b1533; }
        .card-sub { font-size: 12px; color: #9ca3af; margin-top: 2px; }
        .btn-tambah { background: #0b1533; color: #fff; border: none; border-radius: 30px; padding: 9px 18px; font-size: 13px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; transition: background .2s; text-decoration: none; white-space: nowrap; }
        .btn-tambah:hover { background: #1e2f5e; color: #fff; }
        ...
        .search-input { width: 100%; padding: 8px 16px 8px 38px; font-size: 13px; border: 1px solid #e5e7eb; border-radius: 30px; outline: none; transition: all 0.2s; color: #374151; }
        .search-input:focus { border-color: #0b1533; box-shadow: 0 0 0 3px rgba(11, 21, 51, 0.08); }
        ...
        .btn-modal-hapus:hover { background: #be123c; }
    </style>
</head>
<body>
