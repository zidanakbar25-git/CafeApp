...
<head>
    ...
    <title>Edit Admin — Cozy Cafe</title>
...
<div class="admin-layout">
    ...
    <div class="admin-content">
        ...
        <div style="padding:0 30px 10px; margin-top:28px;">
            <div style="font-size:32px;font-weight:700;color:#0b1533;">Edit Admin</div>
            <div style="color:#6b7280;">Ubah data akun <strong>{{ $admin->name ?? $admin->username }}</strong>.</div>
        </div>
